"""Figure: certified upper bounds on the algebraic degree per round."""
import json, sys
import matplotlib
matplotlib.use("Agg")
...
WORD = "DCBA"
add = json.load(open("results/step6_degree_add.json"))["add"]
var = json.load(open("results/step6_degree_xor_none.json"))
...
ax.set_xlabel("rounds $r$"); ax.set_ylabel("mean certified degree bound")
